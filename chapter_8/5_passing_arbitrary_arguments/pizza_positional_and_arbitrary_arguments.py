"""
    ...
    Title: Mixing Positional and Arbitrary Arguments
    Author: Eric Matthes
    Date: 04/15/2023
    Description: "If you want a function to accept several different 
    kinds of arguments, the parameter that accepts an arbitrary number 
    ...
    pizza, that parameter must come before the parameter *toppings:"
